...
set Library     "TetrisPlacementCore"
set IPName      "generateBoardMatrix"
set Version     "1.4"
set DisplayName "Generateboardmatrix"
set Revision    "1906262328"
set Description "An IP generated by Vivado HLS"
set Device      "artix7"
set Taxonomy    "/VIVADO_HLS_IP"

## Variables
set Top "generateBoardMatrix"
...
set Interfaces {
    s_axi_CTRL_BUS {
        ...
        registers {{0x00 CTRL       RW   0x0 "Control signals" {{ 0 1 AP_START RW 0 "Control signal Register for 'ap_start'." } { 1 1 AP_DONE R 0 "Control signal Register for 'ap_done'." } { 2 1 AP_IDLE R 0 "Control signal Register for 'ap_idle'." } { 3 1 AP_READY R 0 "Control signal Register for 'ap_ready'." } { 4 3 RESERVED_1 R 0 "Reserved.  0s on read." } { 7 1 AUTO_RESTART RW 0 "Control signal Register for 'auto_restart'." } { 8 24 RESERVED_2 R 0 "Reserved.  0s on read." }}} {0x04 GIER       RW   0x0 "Global Interrupt Enable Register" {{ 0 1 Enable RW 0 "Master enable for the device interrupt output to the system interrupt controller: 0 = Disabled, 1 = Enabled" } { 1 31 RESERVED R 0 "Reserved.  0s on read." }} } {0x08 IP_IER     RW   0x0 "IP Interrupt Enable Register" {{ 0 1 CHAN0_INT_EN RW 0 "Enable Channel 0 (ap_done) Interrupt.  0 = Disabled, 1 = Enabled." } { 1 1 CHAN1_INT_EN RW 0 "Enable Channel 1 (ap_ready) Interrupt.  0 = Disabled, 1 = Enabled." } { 2 30 RESERVED R 0 "Reserved.  0s on read." }}} {0x0c IP_ISR     RW   0x0 "IP Interrupt Status Register" {{ 0 1 CHAN0_INT_ST RTOW 0 "Channel 0 (ap_done) Interrupt Status. 0 = No Channel 0 input interrupt, 1 = Channel 0 input interrup" } { 1 1 CHAN1_INT_ST RTOW 0 "Channel 1 (ap_ready) Interrupt Status. 0 = No Channel 1 input interrupt, 1 = Channel 1 input interrup" } { 2 30 RESERVED R 0 "Reserved.  0s on read." }}} {0x10 boardOffset W 0x0 "Data signal of boardOffset" {{0 32 boardOffset W 0 "Bit 31 to 0 Data signal of boardOffset"}}} {0x18 pieceChar W 0x0 "Data signal of pieceChar" {{0 8 pieceChar W 0 "Bit 7 to 0 Data signal of pieceChar"} {8 24 RESERVED R 0 "Reserved.  0s on read."}}} {0x20 boardArrayOffset W 0x0 "Data signal of boardArrayOffset" {{0 32 boardArrayOffset W 0 "Bit 31 to 0 Data signal of boardArrayOffset"}}} {0x28 landingHeightArrayOffset W 0x0 "Data signal of landingHeightArrayOffset" {{0 32 landingHeightArrayOffset W 0 "Bit 31 to 0 Data signal of landingHeightArrayOffset"}}} {0x30 placementValidOffset W 0x0 "Data signal of placementValidOffset" {{0 32 placementValidOffset W 0 "Bit 31 to 0 Data signal of placementValidOffset"}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
...
## System Info
set user_parameters_list {clk_period 10.000000 machine 64 combinational 0 latency 2 II x}
...
set enable_xo_gen 0
set kernel_files {C:/Users/Kris/OneDrive/University/MEng/ece1373/project/repoA/monkeyPlaysTetris/commonHWFunctions/generateBoardMatrix.cpp}
if {$enable_xo_gen} {
