...
#ifndef __elTetris2_sitodp_fYi__HH__
#define __elTetris2_sitodp_fYi__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(elTetris2_sitodp_fYi) {
    ...
    SC_CTOR(elTetris2_sitodp_fYi):  ACMP_sitodp_U ("ACMP_sitodp_U") {
