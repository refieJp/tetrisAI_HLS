...
set Library     "elTetris2"
set IPName      "elTetris2"
set Version     "1.0"
set DisplayName "Eltetris2"
set Revision    "1906250037"
...
set Interfaces {
    s_axi_CTRL_BUS {
        ...
        registers {{0x00 CTRL       RW   0x0 "Control signals" {{ 0 1 AP_START RW 0 "Control signal Register for 'ap_start'." } { 1 1 AP_DONE R 0 "Control signal Register for 'ap_done'." } { 2 1 AP_IDLE R 0 "Control signal Register for 'ap_idle'." } { 3 1 AP_READY R 0 "Control signal Register for 'ap_ready'." } { 4 3 RESERVED_1 R 0 "Reserved.  0s on read." } { 7 1 AUTO_RESTART RW 0 "Control signal Register for 'auto_restart'." } { 8 24 RESERVED_2 R 0 "Reserved.  0s on read." }}} {0x04 GIER       RW   0x0 "Global Interrupt Enable Register" {{ 0 1 Enable RW 0 "Master enable for the device interrupt output to the system interrupt controller: 0 = Disabled, 1 = Enabled" } { 1 31 RESERVED R 0 "Reserved.  0s on read." }} } {0x08 IP_IER     RW   0x0 "IP Interrupt Enable Register" {{ 0 1 CHAN0_INT_EN RW 0 "Enable Channel 0 (ap_done) Interrupt.  0 = Disabled, 1 = Enabled." } { 1 1 CHAN1_INT_EN RW 0 "Enable Channel 1 (ap_ready) Interrupt.  0 = Disabled, 1 = Enabled." } { 2 30 RESERVED R 0 "Reserved.  0s on read." }}} {0x0c IP_ISR     RW   0x0 "IP Interrupt Status Register" {{ 0 1 CHAN0_INT_ST RTOW 0 "Channel 0 (ap_done) Interrupt Status. 0 = No Channel 0 input interrupt, 1 = Channel 0 input interrup" } { 1 1 CHAN1_INT_ST RTOW 0 "Channel 1 (ap_ready) Interrupt Status. 0 = No Channel 1 input interrupt, 1 = Channel 1 input interrup" } { 2 30 RESERVED R 0 "Reserved.  0s on read." }}} {0x10 board_offset W 0x0 "Data signal of board_offset" {{0 32 board_offset W 0 "Bit 31 to 0 Data signal of board_offset"}}} {0x18 landingHeight_offset W 0x0 "Data signal of landingHeight_offset" {{0 32 landingHeight_offset W 0 "Bit 31 to 0 Data signal of landingHeight_offset"}}} {0x20 num_batches W 0x0 "Data signal of num_batches" {{0 32 num_batches W 0 "Bit 31 to 0 Data signal of num_batches"}}} {0x28 scoreArrayOffset W 0x0 "Data signal of scoreArrayOffset" {{0 32 scoreArrayOffset W 0 "Bit 31 to 0 Data signal of scoreArrayOffset"}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
    ...
    ap_clk {
        ...
        buses "s_axi_CTRL_BUS m_axi_mem_int m_axi_mem_flt"
        reset "ap_rst_n"
    }
    ap_rst_n {
        type "reset"
    ...
    m_axi_mem_int {
        type "native_axim"
        mode "master"
        port_prefix "m_axi_mem_int"
        data_width "32"
        param_prefix "C_M_AXI_MEM_INT"
    ...
    m_axi_mem_flt {
        type "native_axim"
        mode "master"
        port_prefix "m_axi_mem_flt"
        data_width "32"
        param_prefix "C_M_AXI_MEM_FLT"
        port_width "AWADDR 32 AWID 1 AWUSER 1 WDATA 32 WSTRB 4 WID 1 WUSER 1 ARADDR 32 ARID 1 ARUSER 1 RDATA 32 RID 1 RUSER 1 BID 1 BUSER 1"
        ctype {
            AWLEN {
                Type "integer unsigned"
...
## System Info
set user_parameters_list {clk_period 10.000000 machine 64 combinational 0 latency 19921 II x}
...
set enable_xo_gen 0
set kernel_files {C:/Users/Kris/OneDrive/University/MEng/ece1373/project/repoA/monkeyPlaysTetris/eiTetrisAI/elTetris2.cpp}
if {$enable_xo_gen} {
