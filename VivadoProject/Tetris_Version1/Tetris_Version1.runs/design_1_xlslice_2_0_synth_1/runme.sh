...
HD_PWD='D:/Tetris_Design/Tetris_Version1/Tetris_Version1.runs/design_1_xlslice_2_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_xlslice_2_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_xlslice_2_0.tcl
